...
var SearchContainerHorizontalMargin : number = 10;
var SearchContainerWidth : number =
...
render() {
var { inputWidth , showCancelButton } : any = this.state;
...
var styles : object = StyleSheet.create({
container: {
flex: 1,
flexDirection: 'row',
},
